...
export type ProductDetailsFragment_ProductFragment = { sku: string, name: string, gtin: string, description: string, id: string, isVariantOf: { name: string, productGroupID: string, skuVariants: { activeVariations: any | null, slugsMap: any | null, availableVariations: any | null } | null }, image: Array<{ url: string, alternateName: string }>, brand: { name: string }, offers: { lowPrice: number, offers: Array<{ availability: string, price: number, listPrice: number, itemOffered: { gtin: string, review: Array<{ author: { name: string }, reviewRating: { bestRating: number, ratingValue: number } }>, aggregateRating: { ratingValue: number, reviewCount: number } }, seller: { identifier: string } }> }, review: Array<{ author: { name: string }, reviewRating: { bestRating: number, ratingValue: number } }>, breadcrumbList: { itemListElement: Array<{ item: string, name: string, position: number }> }, additionalProperty: Array<{ propertyID: string, name: string, value: any, valueReference: string }> };
...
export type ServerProductPageQueryQuery = { product: { sku: string, gtin: string, name: string, description: string, releaseDate: string, id: string, seo: { title: string, description: string, canonical: string }, brand: { name: string }, breadcrumbList: { itemListElement: Array<{ item: string, name: string, position: number }> }, image: Array<{ url: string, alternateName: string }>, offers: { lowPrice: number, highPrice: number, priceCurrency: string, offers: Array<{ availability: string, price: number, priceValidUntil: string, priceCurrency: string, itemCondition: string, listPrice: number, seller: { identifier: string }, itemOffered: { gtin: string, review: Array<{ author: { name: string }, reviewRating: { bestRating: number, ratingValue: number } }>, aggregateRating: { ratingValue: number, reviewCount: number } } }> }, isVariantOf: { productGroupID: string, name: string, skuVariants: { activeVariations: any | null, slugsMap: any | null, availableVariations: any | null } | null }, review: Array<{ author: { name: string }, reviewRating: { bestRating: number, ratingValue: number } }>, additionalProperty: Array<{ propertyID: string, name: string, value: any, valueReference: string }> } };
...
export type BrowserProductQueryQuery = { product: { sku: string, name: string, gtin: string, description: string, id: string, isVariantOf: { name: string, productGroupID: string, skuVariants: { activeVariations: any | null, slugsMap: any | null, availableVariations: any | null } | null }, image: Array<{ url: string, alternateName: string }>, brand: { name: string }, offers: { lowPrice: number, offers: Array<{ availability: string, price: number, listPrice: number, itemOffered: { gtin: string, review: Array<{ author: { name: string }, reviewRating: { bestRating: number, ratingValue: number } }>, aggregateRating: { ratingValue: number, reviewCount: number } }, seller: { identifier: string } }> }, review: Array<{ author: { name: string }, reviewRating: { bestRating: number, ratingValue: number } }>, breadcrumbList: { itemListElement: Array<{ item: string, name: string, position: number }> }, additionalProperty: Array<{ propertyID: string, name: string, value: any, valueReference: string }> } };
